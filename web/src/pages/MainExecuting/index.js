...
export default function MainExecuting() {
  ...
  async function loadOsListFiltered() {
    ...
    try {
      const response = await api.get(
        `/serviceOrders/index/period/attendance/?situations=${situationsString}&startDate=${startDate}&endDate=${endDate}`
      );
                              ...
                              <div className="answer">
                                {os.id_status <= 4 ? (
                                  ...
                                  <button
                                    type="button"
                                    title={
                                      os.id_status > 0 && os.id_status < 7
                                        ? "Ainda não é possível finalizar essa ordem de serviço"
                                        : os.id_status == 7
                                        ? "Finalizar ordem de serviço"
                                        : os.id_status == 8 ||
                                          os.id_status == 98
                                        ? "Essa ordem de serviço já foi finalizada"
